...
int ts_bspline_set_degree(SWIGTYPE_p_tsBSpline spline, size_t deg) {
  int ret = cast(int)tinyspline_im.ts_bspline_set_degree(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), deg);
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}
...
int ts_bspline_set_order(SWIGTYPE_p_tsBSpline spline, size_t order) {
  int ret = cast(int)tinyspline_im.ts_bspline_set_order(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), order);
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}
...
int ts_bspline_set_dimension(SWIGTYPE_p_tsBSpline spline, size_t dim) {
  int ret = cast(int)tinyspline_im.ts_bspline_set_dimension(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), dim);
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}
...
int ts_bspline_control_points(SWIGTYPE_p_tsBSpline spline, double** ctrlp) {
  int ret = cast(int)tinyspline_im.ts_bspline_control_points(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), cast(void*)ctrlp);
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

int ts_bspline_control_point_at(SWIGTYPE_p_tsBSpline spline, size_t index, double** ctrlp) {
  int ret = cast(int)tinyspline_im.ts_bspline_control_point_at(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), index, cast(void*)ctrlp);
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

int ts_bspline_set_control_points(SWIGTYPE_p_tsBSpline spline, double* ctrlp) {
  int ret = cast(int)tinyspline_im.ts_bspline_set_control_points(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), cast(void*)ctrlp);
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}
...
int ts_bspline_knots(SWIGTYPE_p_tsBSpline spline, double** knots) {
  int ret = cast(int)tinyspline_im.ts_bspline_knots(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), cast(void*)knots);
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

int ts_bspline_set_knots(SWIGTYPE_p_tsBSpline spline, double* knots) {
  int ret = cast(int)tinyspline_im.ts_bspline_set_knots(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), cast(void*)knots);
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}
...
int ts_deboornet_points(SWIGTYPE_p_tsDeBoorNet net, double** points) {
  int ret = cast(int)tinyspline_im.ts_deboornet_points(SWIGTYPE_p_tsDeBoorNet.swigGetCPtr(net), cast(void*)points);
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}
...
int ts_deboornet_result(SWIGTYPE_p_tsDeBoorNet net, double** result) {
  int ret = cast(int)tinyspline_im.ts_deboornet_result(SWIGTYPE_p_tsDeBoorNet.swigGetCPtr(net), cast(void*)result);
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}
...
int ts_bspline_copy(SWIGTYPE_p_tsBSpline original, SWIGTYPE_p_tsBSpline _copy_) {
  int ret = cast(int)tinyspline_im.ts_bspline_copy(SWIGTYPE_p_tsBSpline.swigGetCPtr(original), SWIGTYPE_p_tsBSpline.swigGetCPtr(_copy_));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

void ts_bspline_move(SWIGTYPE_p_tsBSpline from, SWIGTYPE_p_tsBSpline _to_) {
  tinyspline_im.ts_bspline_move(SWIGTYPE_p_tsBSpline.swigGetCPtr(from), SWIGTYPE_p_tsBSpline.swigGetCPtr(_to_));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
}
...
int ts_deboornet_copy(SWIGTYPE_p_tsDeBoorNet original, SWIGTYPE_p_tsDeBoorNet _copy_) {
  int ret = cast(int)tinyspline_im.ts_deboornet_copy(SWIGTYPE_p_tsDeBoorNet.swigGetCPtr(original), SWIGTYPE_p_tsDeBoorNet.swigGetCPtr(_copy_));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

void ts_deboornet_move(SWIGTYPE_p_tsDeBoorNet from, SWIGTYPE_p_tsDeBoorNet _to_) {
  tinyspline_im.ts_deboornet_move(SWIGTYPE_p_tsDeBoorNet.swigGetCPtr(from), SWIGTYPE_p_tsDeBoorNet.swigGetCPtr(_to_));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
}

void ts_deboornet_free(SWIGTYPE_p_tsDeBoorNet _net_) {
  tinyspline_im.ts_deboornet_free(SWIGTYPE_p_tsDeBoorNet.swigGetCPtr(_net_));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
}

int ts_bspline_interpolate_cubic(double* points, size_t n, size_t dim, SWIGTYPE_p_tsBSpline _spline_) {
  int ret = cast(int)tinyspline_im.ts_bspline_interpolate_cubic(cast(void*)points, n, dim, SWIGTYPE_p_tsBSpline.swigGetCPtr(_spline_));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

int ts_bspline_eval(SWIGTYPE_p_tsBSpline spline, double u, SWIGTYPE_p_tsDeBoorNet _deBoorNet_) {
  int ret = cast(int)tinyspline_im.ts_bspline_eval(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), u, SWIGTYPE_p_tsDeBoorNet.swigGetCPtr(_deBoorNet_));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}
...
int ts_bspline_insert_knot(SWIGTYPE_p_tsBSpline spline, double u, size_t n, SWIGTYPE_p_tsBSpline _result_, size_t* _k_) {
  int ret = cast(int)tinyspline_im.ts_bspline_insert_knot(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), u, n, SWIGTYPE_p_tsBSpline.swigGetCPtr(_result_), cast(void*)_k_);
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

int ts_bspline_resize(SWIGTYPE_p_tsBSpline spline, int num_control_points, int back, SWIGTYPE_p_tsBSpline _resized_) {
  int ret = cast(int)tinyspline_im.ts_bspline_resize(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), num_control_points, back, SWIGTYPE_p_tsBSpline.swigGetCPtr(_resized_));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

int ts_bspline_split(SWIGTYPE_p_tsBSpline spline, double u, SWIGTYPE_p_tsBSpline _split_, size_t* _k_) {
  int ret = cast(int)tinyspline_im.ts_bspline_split(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), u, SWIGTYPE_p_tsBSpline.swigGetCPtr(_split_), cast(void*)_k_);
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

int ts_bspline_buckle(SWIGTYPE_p_tsBSpline spline, double b, SWIGTYPE_p_tsBSpline _buckled_) {
  int ret = cast(int)tinyspline_im.ts_bspline_buckle(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), b, SWIGTYPE_p_tsBSpline.swigGetCPtr(_buckled_));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

int ts_bspline_to_beziers(SWIGTYPE_p_tsBSpline spline, SWIGTYPE_p_tsBSpline _beziers_) {
  int ret = cast(int)tinyspline_im.ts_bspline_to_beziers(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), SWIGTYPE_p_tsBSpline.swigGetCPtr(_beziers_));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

int ts_bspline_to_json(SWIGTYPE_p_tsBSpline spline, char** _json_) {
  int ret = cast(int)tinyspline_im.ts_bspline_to_json(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), cast(void*)_json_);
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

int ts_bspline_from_json(string json, SWIGTYPE_p_tsBSpline _spline_) {
  int ret = cast(int)tinyspline_im.ts_bspline_from_json((json ? std.string.toStringz(json) : null), SWIGTYPE_p_tsBSpline.swigGetCPtr(_spline_));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

int ts_bspline_save_json(SWIGTYPE_p_tsBSpline spline, string path) {
  int ret = cast(int)tinyspline_im.ts_bspline_save_json(SWIGTYPE_p_tsBSpline.swigGetCPtr(spline), (path ? std.string.toStringz(path) : null));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

int ts_bspline_load_json(string path, SWIGTYPE_p_tsBSpline _spline_) {
  int ret = cast(int)tinyspline_im.ts_bspline_load_json((path ? std.string.toStringz(path) : null), SWIGTYPE_p_tsBSpline.swigGetCPtr(_spline_));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}
...
string ts_enum_str(int err) {
  string ret = std.conv.to!string(tinyspline_im.ts_enum_str(cast(int)err));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}

int ts_str_enum(string str) {
  int ret = cast(int)tinyspline_im.ts_str_enum((str ? std.string.toStringz(str) : null));
  if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
  return ret;
}
...
class BSpline {
  ...
  public BSpline resize(int n, int back) const {
    BSpline ret = new BSpline(tinyspline_im.BSpline_resize(cast(void*)swigCPtr, n, back), true);
    if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
    return ret;
  }
...
class Utils {
  ...
  public static string enum_str(int err) {
    string ret = std.conv.to!string(tinyspline_im.Utils_enum_str(cast(int)err));
    if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
    return ret;
  }

  public static int str_enum(string str) {
    int ret = cast(int)tinyspline_im.Utils_str_enum((str ? std.string.toStringz(str) : null));
    if (tinyspline_im.SwigPendingException.isPending) throw tinyspline_im.SwigPendingException.retrieve();
    return ret;
  }
}

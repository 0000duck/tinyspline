...
static this() {
  ...
  mixin(bindCode("ts_enum_str", "D_ts_enum_str"));
  mixin(bindCode("ts_str_enum", "D_ts_str_enum"));
  ...
  mixin(bindCode("Utils_enum_str", "D_Utils_enum_str"));
  mixin(bindCode("Utils_str_enum", "D_Utils_str_enum"));
...
SwigExternC!(int function(void* jarg1, size_t jarg2)) ts_bspline_set_order;
SwigExternC!(size_t function(void* jarg1)) ts_bspline_dimension;
SwigExternC!(int function(void* jarg1, size_t jarg2)) ts_bspline_set_dimension;
...
SwigExternC!(int function(void* jarg1, void* jarg2)) ts_bspline_control_points;
SwigExternC!(int function(void* jarg1, size_t jarg2, void* jarg3)) ts_bspline_control_point_at;
SwigExternC!(int function(void* jarg1, void* jarg2)) ts_bspline_set_control_points;
SwigExternC!(int function(void* jarg1, size_t jarg2, void* jarg3)) ts_bspline_set_control_point_at;
SwigExternC!(size_t function(void* jarg1)) ts_bspline_num_knots;
SwigExternC!(size_t function(void* jarg1)) ts_bspline_sof_knots;
SwigExternC!(int function(void* jarg1, void* jarg2)) ts_bspline_knots;
SwigExternC!(int function(void* jarg1, void* jarg2)) ts_bspline_set_knots;
...
SwigExternC!(int function(void* jarg1, void* jarg2)) ts_deboornet_points;
...
SwigExternC!(int function(void* jarg1, void* jarg2)) ts_deboornet_result;
SwigExternC!(void* function()) ts_bspline_init;
SwigExternC!(int function(size_t jarg1, size_t jarg2, size_t jarg3, int jarg4, void* jarg5)) ts_bspline_new;
SwigExternC!(int function(void* jarg1, void* jarg2)) ts_bspline_copy;
...
SwigExternC!(int function(void* jarg1, void* jarg2)) ts_deboornet_copy;
SwigExternC!(void function(void* jarg1, void* jarg2)) ts_deboornet_move;
SwigExternC!(void function(void* jarg1)) ts_deboornet_free;
SwigExternC!(int function(void* jarg1, size_t jarg2, size_t jarg3, void* jarg4)) ts_bspline_interpolate_cubic;
...
SwigExternC!(int function(void* jarg1, double jarg2, void* jarg3)) ts_bspline_buckle;
SwigExternC!(int function(void* jarg1, void* jarg2)) ts_bspline_to_beziers;
SwigExternC!(int function(void* jarg1, void* jarg2)) ts_bspline_to_json;
SwigExternC!(int function(const(char)* jarg1, void* jarg2)) ts_bspline_from_json;
SwigExternC!(int function(void* jarg1, const(char)* jarg2)) ts_bspline_save_json;
SwigExternC!(int function(const(char)* jarg1, void* jarg2)) ts_bspline_load_json;
SwigExternC!(int function(double jarg1, double jarg2)) ts_fequals;
SwigExternC!(const(char)* function(int jarg1)) ts_enum_str;
SwigExternC!(int function(const(char)* jarg1)) ts_str_enum;
...
SwigExternC!(const(char)* function(int jarg1)) Utils_enum_str;
SwigExternC!(int function(const(char)* jarg1)) Utils_str_enum;
